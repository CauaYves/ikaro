  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.modalidade.index', $registro->campeonato_id) }}">Modalidade</a></li>
        <li class="breadcrumb-item active" aria-current="page">Editar</li>
      </ol>
    </nav><br>

    <form action="{{ route('admin.modalidade.atualizar', $registro->id) }}" method="post">
      {{ csrf_field() }}
