  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.alunos_turma.index', $turma->id) }}">Alunos da Turma</a></li>
        <li class="breadcrumb-item active" aria-current="page">Editar</li>
      </ol>
    </nav><br>

    <form action="{{ route('admin.alunos_turma.atualizar', $registro->id) }}" method="post">
      {{ csrf_field() }}
