		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-success" style="text-align: center;"><b>{{ $r->aluno->nome }}</b></td>
					<td class="text-success" style="text-align: center;" class="dinheiro"><b>{{ $r->parcela }}</b></td>
				...
				<tr>
					...
					<td class="text-danger" style="text-align: center;"><b>{{ $r->aluno->nome }}</b></td>
					<td class="text-danger" style="text-align: center;" class="dinheiro"><b>{{ $r->parcela }}</b></td>
				...
				<tr>
					...
					<td style="text-align: center;">{{ $r->aluno->nome }}</td>
